...
import { ChevronLeft, ChevronRight, Trophy, Users, Target, Zap, Eye, Shield, Star } from 'lucide-react';
...
export const About = ({ isDarkMode }: { isDarkMode: boolean }) => {
  ...
  return (
    <div className={`pb-24 ${isDarkMode ? 'bg-zinc-950' : 'bg-zinc-50'}`}>
      ...
      {/* ── Performance Review Carousel ── */}
      <section className={`py-14 md:py-20 border-t ${isDarkMode ? 'border-white/5' : 'border-zinc-200'}`}>
