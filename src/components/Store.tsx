...
export const Store = ({ isDarkMode }: { isDarkMode: boolean }) => (
  <section className={`py-12 md:py-16 px-4 md:px-8 ${isDarkMode ? 'bg-zinc-950' : 'bg-white'}`}>
    <div className="max-w-7xl mx-auto">
      <div className="mb-8 md:mb-10">
        <h2 className={`text-2xl md:text-3xl font-black ${isDarkMode ? 'text-white' : 'text-zinc-900'}`}>
          OFFICIAL STORE
        </h2>
          ...
          <article key={p.name}
            ...
            <div className="p-4 flex items-center justify-between">
              ...
              <a href={`https://wa.me/233208161814?text=${p.waMsg}`}
                ...
                className="px-4 py-2 rounded-full text-xs font-bold border transition hover:opacity-70 whitespace-nowrap"
